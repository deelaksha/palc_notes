...
export default function NetworkingExercisesPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <Card>
          <CardHeader className="text-center">
            ...
            <CardTitle className="font-headline text-3xl">Networking Exercises</CardTitle>
            <p className="text-center text-muted-foreground pt-2">Select an exercise to begin.</p>
          </CardHeader>
          <CardContent>
