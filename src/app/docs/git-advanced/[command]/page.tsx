...
export function generateStaticParams() {
  return gitAdvancedCommandsData.map((command) => ({
...
export default function CommandDetailPage({
  ...
  const command = gitAdvancedCommandsData.find((cmd) => cmd.name.replace(/\s+/g, '-') === params.command);
