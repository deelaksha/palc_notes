...
export default function NsShowHubPage() {
  const options = [
    {
      name: 'Theory',
      description: 'An explanation of how the script works, line by line.',
      href: '/docs/notes/frr-exercises/exercise1/ns-show-sh/theory',
      icon: <BookOpen className="size-8" />,
    },
    {
      name: 'Practical',
      description: 'A hands-on exercise to see the script\'s output.',
      href: '/docs/notes/frr-exercises/exercise1/ns-show-sh/practical',
