...
export default function NsCreateHubPage() {
  const options = [
    {
      name: 'Theory',
      description: 'An explanation of how the script works, line by line.',
      href: '/docs/notes/frr-exercises/exercise1/ns-create-sh/theory',
      icon: <BookOpen className="size-8" />,
    },
    {
      name: 'Practical',
      description: 'A hands-on exercise using the script.',
      href: '/docs/notes/frr-exercises/exercise1/ns-create-sh/practical',
