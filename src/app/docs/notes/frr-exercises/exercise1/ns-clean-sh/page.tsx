...
export default function NsCleanHubPage() {
  const options = [
    {
      name: 'Theory',
      description: 'An explanation of how the cleanup script works.',
      href: '/docs/notes/frr-exercises/exercise1/ns-clean-sh/theory',
      icon: <BookOpen className="size-8" />,
    },
    {
      name: 'Practical',
      description: 'A hands-on animation showing the cleanup process.',
      href: '/docs/notes/frr-exercises/exercise1/ns-clean-sh/practical',
