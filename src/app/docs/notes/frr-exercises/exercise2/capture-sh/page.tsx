...
export default function NsCaptureHubPage() {
  const options = [
    {
      name: 'Theory',
      description: 'An explanation of how the capture script works.',
      href: '/docs/notes/frr-exercises/exercise2/capture-sh/theory',
      icon: <BookOpen className="size-8" />,
    },
    {
      name: 'Practical',
      description: 'A hands-on animation showing packet capture.',
      href: '/docs/notes/frr-exercises/exercise2/capture-sh/practical',
