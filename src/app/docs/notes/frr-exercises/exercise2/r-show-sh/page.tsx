...
export default function RShowHubPage() {
  const options = [
    {
      name: 'Theory',
      description: 'An explanation of how the diagnostic script works.',
      href: '/docs/notes/frr-exercises/exercise2/r-show-sh/theory',
      icon: <BookOpen className="size-8" />,
    },
    {
      name: 'Practical',
      description: 'See a simulation of the script\'s output.',
      href: '/docs/notes/frr-exercises/exercise2/r-show-sh/practical',
