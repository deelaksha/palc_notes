...
export default function RCreateHubPage() {
  const options = [
    {
      name: 'Theory',
      description: 'An explanation of how the script creates the router topology.',
      href: '/docs/notes/frr-exercises/exercise3/r-create-sh/theory',
      icon: <BookOpen className="size-8" />,
    },
    {
      name: 'Practical',
      description: 'A hands-on animation showing the creation process.',
      href: '/docs/notes/frr-exercises/exercise3/r-create-sh/practical',
    ...
    <div className="flex flex-col flex-1">
      <main className="flex-1 p-4 md:p-8 lg:p-12">
         <Button asChild variant="ghost" className="mb-8">
            <Link href="/docs/notes/frr-exercises/exercise3">
