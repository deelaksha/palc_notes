...
export default function RCleanHubPage() {
  const options = [
    {
      name: 'Theory',
      description: 'An explanation of how the cleanup script works.',
      href: '/docs/notes/frr-exercises/exercise3/r-clean-sh/theory',
      icon: <BookOpen className="size-8" />,
    },
    {
      name: 'Practical',
      description: 'A hands-on animation showing the cleanup process.',
      href: '/docs/notes/frr-exercises/exercise3/r-clean-sh/practical',
