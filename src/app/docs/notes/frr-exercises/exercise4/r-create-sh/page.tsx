...
export default function RCreateHubPage() {
  const options = [
    {
      name: 'Theory',
      description: 'An explanation of how the script creates the dual-router topology.',
      href: '/docs/notes/frr-exercises/exercise4/r-create-sh/theory',
      icon: <BookOpen className="size-8" />,
    },
    {
      name: 'Practical',
      description: 'A hands-on animation showing the creation process.',
      href: '/docs/notes/frr-exercises/exercise4/r-create-sh/practical',
